...
<meta charset="UTF-8">
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/mypage_designer/css/review.css">
	<title>매장 리뷰</title>
</head>
<body>
	<header>
			...
			<section class="right">
				<div class="review-container">
					<div class="review-card">
						<img src="${pageContext.request.contextPath}/mypage_user/img/장원영.jpeg" alt="후기 사진">
						<div class="card-body">
							<div class="user-reserve">
								<img src="${pageContext.request.contextPath}/mypage_designer/img/profile.png"
									alt="프로필 사진">
								<p>고객 이름</p>
								<p>시술 종류</p>
							</div>
