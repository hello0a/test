<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	...
	<body>
		...
		<div class="review-container">
			...
			<div class="content">
				<div class="user-info">
					<img src="이미지 추후 추가" alt="Profile" class="profile-img"> <span class="user-name">예진0928 님</span>
				</div>

				<div class="form-group">
					<div class="select-wrapper">
						<select class="input-field" id="designer-select">
							<option value="" disabled selected>디자이너 선택 ▽</option>
							<option value="예진">예진 디자이너</option>
							<option value="민수">민수 디자이너</option>
							<option value="수아">수아 디자이너</option>
						</select>
					</div>
					...
					<button type="button" class="file-upload-btn" id="upload-btn">사진
						첨부하기</button>
				...
				<button type="button" class="submit-btn" onclick="submitReview()">리뷰
					작성완료</button>
			</div>
		</div>
