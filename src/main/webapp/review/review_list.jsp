	...
	<body>
		...
		<div class="review-list-container">
			...
			<div class="review-type-tabs">
				...
				<button class="type-btn instagram" onclick="location.href='https://www.instagram.com'">인스타그램
					리뷰</button>
			</div>
			...
			<div class="review-items" id="review-list">
				...
				<div class="review-card" data-designer="김조은">
					<div class="user-header">
						<img src="C:/Users/TJ-BU-706-P05/.gemini/antigravity/brain/7284db52-135a-4a93-b28a-e4bbf91d4791/uploaded_image_1766546978340.jpg"
							class="user-avatar">
						<div class="user-meta">
							<span class="uid">예진0928</span> <span class="handle">@YJ0928</span>
						</div>
					</div>
					<div class="review-content">
						...
						<div class="review-body">
							...
							<div class="review-text">단발병이 와서 과감히 잘라봤는데 너무 가볍고 맘에 들어요!
								앞머리도 적당하고, 드라이 대충 해도 스타일이 살아서 편해요.</div>
							<div class="card-footer">
								<span class="help-btn" onclick="toggleHelp(this)">👍 도움이
									됐어요 <span class="count">0</span>
								</span> <span class="date">2025.11.15</span>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="review-card" data-designer="박한별">
					<div class="user-header">
						<!-- 이미지 추후 추가 -->
						<img src="추후추가" class="user-avatar">
						<div class="user-meta">
							<span class="uid">석현0732</span> <span class="handle">@SH0087</span>
						</div>
					</div>
					<div class="review-content">
						<div class="review-img-placeholder">추후입력</div>
						<div class="review-body">
							...
							<div class="review-text">옆머리가 붕 뜨는 게 고민이라 다운펌 같이 했는데, 진짜 착
								붙어서 두상이 작아 보여요! ✨ 아침에 털어서 말리기만 해도 스타일이 잡혀서 편하네요.</div>
							<div class="card-footer">
								<span class="help-btn" onclick="toggleHelp(this)">👍 도움이
									됐어요 <span class="count">0</span>
								</span> <span class="date">2025.11.09</span>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="review-card hidden" data-designer="이민지">
					<div class="user-header">
						...
						<img src="추후추가" class="user-avatar">
						<div class="user-meta">
							<span class="uid">민지0123</span> <span class="handle">@MJ0123</span>
						</div>
					</div>
					<div class="review-content">
						<div class="review-img-placeholder">추후입력</div>
						<div class="review-body">
							...
							<div class="review-text">친절하게 상담해주시고 딱 제가 원하는 컬로 뽑아주셨어요.
								머리카락 손상도 하나도 없어서 너무 만족합니다!</div>
							<div class="card-footer">
								<span class="help-btn" onclick="toggleHelp(this)">👍 도움이
									됐어요 <span class="count">0</span>
								</span> <span class="date">2025.10.28</span>
							</div>
						</div>
					</div>
				</div>
